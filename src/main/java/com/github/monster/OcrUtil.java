...
public class OcrUtil {
    ...
    public static OcrResult NcnnOcr(String dir, String imagePath) {
        return Ocr(dir + File.separator + "libRapidOcrNcnn", dir + File.separator + "models", "ch_PP-OCRv3_det_infer", "ch_ppocr_mobile_v2.0_cls_infer", "ch_PP-OCRv3_rec_infer", "ppocr_keys_v1.txt", imagePath, 4, null, null, null, null, null, null, null, 0);
    }

    public static OcrResult OnnxOcr(String dir, String imagePath) {
        return Ocr(dir + File.separator + "libRapidOcrOnnx", dir + File.separator + "models", "ch_PP-OCRv3_det_infer.onnx", "ch_ppocr_mobile_v2.0_cls_infer.onnx", "ch_PP-OCRv3_rec_infer.onnx", "ppocr_keys_v1.txt", imagePath, 4, null, null, null, null, null, null, null, null);
    }
