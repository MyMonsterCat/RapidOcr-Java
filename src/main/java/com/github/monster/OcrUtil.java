...
public class OcrUtil {
    ...
    public static OcrResult NcnnOcr(String imagePath) {
        return Ocr("ncnn/RapidOcrNcnn", "ncnn/models", "ch_PP-OCRv3_det_infer","ch_ppocr_mobile_v2.0_cls_infer" , "ch_PP-OCRv3_rec_infer", "ppocr_keys_v1.txt", imagePath, null, null,null,null,null,null,null,null,0);
    }

    public static OcrResult OnnxOcr(String imagePath) {
        return Ocr("onnx/RapidOcrOnnx", "onnx/models", "ch_PP-OCRv3_det_infer.onnx","ch_ppocr_mobile_v2.0_cls_infer.onnx" , "ch_PP-OCRv3_rec_infer.onnx", "ppocr_keys_v1.txt", imagePath, null, null,null,null,null,null,null,null,null);
    }


    /**
     * @param modelsDir      模型路径，run-test/models
     * @param detName        ch_PP-OCRv3_det_infer
     * @param clsName        ch_ppocr_mobile_v2.0_cls_infer
     * @param recName        ch_PP-OCRv3_rec_infer
     * @param keysName       ppocr_keys_v1.txt
     * @param imagePath      待识别的图片地址：run-test/images/1.jpg
